...
public class MeasureReportDownloader implements IReportDownloader {
  ...
  @Override
  public void download(String reportId, String downloadType, FhirDataProvider fhirDataProvider, HttpServletResponse response, FhirContext ctx, ApiConfig config) throws IOException, TransformerException {
