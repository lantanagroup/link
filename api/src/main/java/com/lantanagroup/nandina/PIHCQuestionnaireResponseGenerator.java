...
public class PIHCQuestionnaireResponseGenerator {
  ...
  public QuestionnaireResponse generate() {
    ...
    section1.addItem(this.createAnswer(PIHCConstants.HOSPITALIZED, "numC19HospPats", "Patients currently hospitalized in an inpatient bed who have suspected or confirmed COVID-19", IntegerType.class));
    section1.addItem(this.createAnswer(PIHCConstants.HOSPITALIZED_AND_VENTILATED, "numC19MechVentPats", "Patients currently hospitalized in an inpatient bed who have suspected or confirmed COVID-19 and are on a mechanical ventilator", IntegerType.class));
    ...
    section2.addItem(this.createAnswer(PIHCConstants.HOSPITAL_ICU_BED_OCC, "numICUBedsOcc", "Total number of staffed inpatient ICU beds that are occupied", IntegerType.class));
    section2.addItem(this.createAnswer(PIHCConstants.MECHANICAL_VENTILATORS, "numVent", "Total number of ventilators available", IntegerType.class));
    section2.addItem(this.createAnswer(PIHCConstants.MECHANICAL_VENTILATORS_USED, "numVentUse", "Total number of ventilators in use", IntegerType.class));
