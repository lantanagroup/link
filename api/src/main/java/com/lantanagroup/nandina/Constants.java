...
public class Constants {
  ...
  public static final String PREV_DAY_COVID_ADMIT = "previousDayCovidAdmitted";
  public static final String PREV_DAY_SUSPECT_COVID_ADMIT = "previousDaySuspectedCovidAdmitted";
  public static final String PREV_DAY_HOSPITAL_ONSET = "previousDayHospitalOnset";
  public static final String PREV_DAY_HOSPITAL_ONSET_COVID = "previousDayHospitalOnsetCovid";
  public static final String PREV_DAYS_DEATHS = "previousDayDeaths";
  public static final String PREV_DAY_DEATHS_COVID = "previousDayDeathsCovid";
}
