...
//  private CsrfTokenRepository customCsrfTokenRepository; //custom csrfToken repository
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    authFilter.setAuthenticationManager(new LinkAuthManager(config.getIssuer(), config.getAlgorithm(), config.getAuthJwksUrl(), config.getTokenVerificationClass(), null));
