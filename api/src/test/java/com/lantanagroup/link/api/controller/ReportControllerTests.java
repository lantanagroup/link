...
import com.lantanagroup.link.nhsn.FHIRSender;
...
//  }
  ...
  public void getReportPatientsTest() throws Exception {
    ...
    ListResource refs = new ListResource();
    ListResource.ListEntryComponent ref1 = new ListResource.ListEntryComponent();
    ...
    MasterMeasureReport.setId("MeasureReport/report1");
    ...
    MasterMeasureReport.addContained(refs);
    when(fhirDataProvider.getMeasureReportById("report1")).thenReturn(MasterMeasureReport);
    when(fhirDataProvider.getMeasureReportById(String.valueOf(patient1Hash))).thenReturn(measureReport1);
    when(fhirDataProvider.getMeasureReportById(String.valueOf(patient2Hash))).thenReturn(measureReport2);
